...
export function getBankCard (cardNo) {

  const url = "https://xk.gzskxx.com/bankCard/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=" + cardNo + "&cardBinCheck=true"
