...
<script>
	...
	export default {
		...
		mounted: function() {
			const startDate = addDays(startOfWeek(new Date(), {
				weekStartsOn: 1
			}), -7);
		...
		.salesCon {
			...
			.category {
				...
				.total {
					width: 330upx;
					height: 180upx;
					box-shadow: 0upx 0upx 20upx 0upx rgba(107, 122, 248, 0.21);
					border-radius: 10upx;
					border-left: 16upx solid #808AFC;
				}
				...
				.week {
					...
					box-shadow: 0upx 0upx 20upx 0upx rgba(107, 122, 248, 0.21);
					border-radius: 10upx;
					border-left: 16upx solid #FF8272;
				}

				.title {
					font-size: 24upx;
					color: #666666;
					padding: 26upx 0 33upx 0upx;
				}
