<template>
	<view class="container">
		...
		<!-- 店铺类型 -->
		<view class="shopName oneList fx-row fx-row-center">
			<text class="left"><text class="pot">*</text>店铺类型</text>
			<picker :value="value1" :range="typeRange" class="perRight fx-row fx-row-space-between fx-row-center" style="display: flex;flex-direction: row;align-items: center;justify-content: space-between;" mode="selector"  @change="typeChange">
		...
		<view class="company oneList fx-row fx-row-center">
			...
			<input v-model="companyName" type="text"  placeholder="请输入真实姓名" placeholder-class="beforeinput" class="input"/>
		</view>
		
		<!-- 手机号码 -->
		<view class="company oneList fx-row fx-row-center" style="margin-top: 20upx;">
			<text class="left"><text class="pot">*</text>手机号码</text>
			<input v-model="companyName" type="text"  placeholder="请输入手机号码" placeholder-class="beforeinput" class="input"/>
		</view>

		<!-- 宣传视频 -->
		<view class="video oneList fx-row fx-row-center fx-row-left" @click="UpVideo">
			<text class="left"><text class="pot">*</text>宣传视频</text>
			<view class="perRight fx-row fx-row-space-between fx-row-center">
