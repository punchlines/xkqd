<template name="uni-countdown">
	<view class="uni-countdown">
		<view class="uni-countdown-numbers" :style="{color:fontColor}">{{d}}</view>
		<view class="uni-countdown-splitor" :style="{color:splitorColor}">:</view>
		<view class="uni-countdown-numbers" :style="{color:fontColor}">{{h}}</view>
		<view class="uni-countdown-splitor" :style="{color:splitorColor}">:</view>
		<view class="uni-countdown-numbers" :style="{color:fontColor}">{{i}}</view>
		<view class="uni-countdown-splitor" :style="{color:splitorColor}">:</view>
		<view class="uni-countdown-numbers" :style="{color:fontColor}">{{s}}</view>
	</view>
</template>
<script>
	export default {
		...
		methods: {
			...
			countDown: function(self) {
				...
				if (leftTime > 0) {
					var day=parseInt(leftTime / 1000 / 60, 10);
