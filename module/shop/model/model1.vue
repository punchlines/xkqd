<template>
	<view class="page">
		...
		<view class="shop-info">
			<image class="shop-back" src="http://card-1254165941.cosgz.myqcloud.com/shopTemplate/bg4.png"></image>
		...
		<view class="icon_img" v-if="isSelfShop">
			<view class="icon_mel" @click="changeTemplate">
				<view class="fir">
					<img src="http://card-1254165941.cosgz.myqcloud.com/shopTemplate/ficon1.png" alt="" mode="aspectFit">
					<text>店铺模板</text>
				</view>
			...
			<view class="icon_sec" @click="pusblishGoods">
				<view class="fir">
					<img src="http://card-1254165941.cosgz.myqcloud.com/shopTemplate/ficon2.png" alt="" mode="aspectFit">
					<text>发布新商品</text>
				</view>
			...
			<view class="icon_thi" @click="underGoods">
				<view class="fir">
					<img src="http://card-1254165941.cosgz.myqcloud.com/shopTemplate/ficon3.png" alt="" mode="aspectFit">
					<text>下架商品</text>
				</view>
			...
			<view class="icon_fou" @click="openVip">
				<view class="fir">
					<img src="http://card-1254165941.cosgz.myqcloud.com/shopTemplate/ficon4.png" alt="" mode="aspectFit">
					<text>尊享VIP</text>
				</view>
		...
		<view class="goods_hot_list" :style="{'display':listStyle}">
			<goodsFour v-for="(n,index) in recommendShopGoods" :key='index' :value="n" :shopId='shopIdOtherPeople' :SignIn='SignIn'
			 :cardUserId='cardUserId' :isSelfShop="isSelfShop" @allMoreInfo="allmoreInfo" @addCar="addCar" :recommend-id="recommendId"></goodsFour>
		...
		<view class="goods_list">
			<goodsThcopy v-for="(n,index) in shopGoods" :key='index' :goods="n" :value="n" :shopId='shopIdOtherPeople' :SignIn='SignIn'
			 :cardUserId='cardUserId' @addCar="addCar" :isSelfShop="isSelfShop" @allMoreInfo="allmoreInfo" :recommend-id="recommendId"></goodsThcopy>
		...
		<exclusive-shop-modal :shop-data='shopData' :recommend-list='recommendShopGoods' :shop-id="shopIdOtherPeople"
		 :card-user-id="cardUserId" v-if="exclusiveVisible" @close="exclusiveVisible = false"></exclusive-shop-modal>
...
<script>
	...
	import goodsThcopy from '../_component/goodsThcopy';
	import goodsFour from '../_component/goodsFour';
	...
	export default {
		...
		methods: {
			...
			changeTemplate() { //更换店铺模板
				uni.navigateTo({
					url: '../../../item_businessCard/businessCard_ShopTemplate/businessCard_ShopTemplate?shopId=' + this.shopId +
			...
			pusblishGoods() { //发布商品
				...
				uni.navigateTo({
					url: '../../../item_businessCard/businessCard_publishNewGoods/businessCard_publishNewGoods?shopId=' + this.shopId +
...
<style scoped lang="less">
	...
	.shop-info {
		...
		.btn_shop_collect {
			...
			&.collected {
				border: 1upx solid rgba(83, 83, 83, 1);
				color: rgba(18, 18, 18, 1);
			}
